...
**Status:** Done (Session 4 — 2026-06-23). Session 5 (2026-07-18) rebuilt the tactic engine end to end: expanded from 6 to 11 tactics, then rewritten as named lessons (Name → Rule → Here), then extended with reverse/hidden/generalized techniques, Team Shadow, a checked-trail, and one-dead-end-at-a-time What-If with Apply All.
